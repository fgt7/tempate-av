...
for (var i = 0; i < data.length; i++) {
	...
	//create bokep cards
	videos += "<div class='bokep-card' data-kategori='" + kategori + "' data-nama='" + nama + "' data-link='" + link + "' data-poster='"+ poster +"'><a class='button-bokep' href='' data-obj='"+ i +"'><div class='card text-left'><img src='" + poster + "' width='100%' height='120px'><div class='judul-bokep' style='color:black;'><b>" + nama + "</b></div></a></div></div>";
...
$(".filter").on("change",function() {
	...
	if (filters == "") {
		...
		$(".bokep-card").hide();
		$(".bokep-card").hide().filter(filters).show();
	}
});
...
$(document).ready(function(){
  var list = $("#list-bokep .bokep-card");
  var numToShow = 50;
  var button = $("#bokep-lainnya");
...
function innerContent2(content){
  $(".inner-title-bokep").html(data[content].title);
  $(".inner-poster-bokep").attr("src",data[content].poster);
  $(".inner-link-bokep").attr("src",data[content].link);
  $(".inner-kategori-bokep").html(data[content].kategori);
};

//Open post:
$(".button-bokep").click(function(e){
  e.preventDefault();
  thisElement2 = $(this).attr("data-obj");
  innerContent2(thisElement2);
  $("#list-bokep").css({"display":"none"});
  $("#filter").css({"display":"none"});
  $("#bokep-lainnya").css({"display":"none"});
  $("#detail-video").css({"display":"block"});
...
//Close post:
$(".close-bokep").click(function(){
  $("#list-bokep").css({"display":"block"});
  $("#list-bokep").css({"display":"grid"});
  $("#list-bokep").css({"grid-template-rows":"173px auto"});
  $("#list-bokep").css({"grid-template-columns":"50% auto"});
  $("#list-bokep").css({"grid-row-gap":"10px"});
  $("#list-bokep").css({"grid-column-gap":"10px"});
  $("#detail-video").css({"display":"none"});
  $("#filter").css({"display":"block"});
  $("#bokep-lainnya").css({"display":"block"});
...
//Button disable:
function dissBtn(){
  $(".prev-bokep, .next-bokep").removeClass("disabled");
  if (thisElement2<=0){
    $(".prev-bokep").addClass("disabled");
  }
  else if (thisElement2>=dataLength-1){
    $(".next-bokep").addClass("disabled");
  };
};
...
$(".prev-bokep").on("click", function() {
    $(window).scrollTop(0);
});

$(".next-bokep").on("click", function() {
    $(window).scrollTop(0);
});

$(".close-bokep").on("click", function() {
    $(window).scrollTop(0);
});