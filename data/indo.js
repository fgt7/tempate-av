$(function () {
  ...
  callback: function (data, pagination) {
      ...
      $.each(data, function (index, item) {
          dataHtml += '<tr><td><div class="row sort-item"><a href="https://dood.la/e/' + item.link + '" target="_blank" style="color:black"><img id="poster1" src="' + item.poster + '" width="100%" height="223" style="object-fit: cover;"></div><div class="d-flex"><h6 id="judul">' + item.title + '</h6></a><a href="https://droplink.co/st?api=8b8315c6bc13a8684492a125284cd883e95e6373&url=https://dood.la/d/' + item.link + '" target="_blank" style="color:black"><i class="fa fa-download" aria-hidden="true"></i></a></div><br></td><tr>';
          });
          dataHtml += '<tr>';
