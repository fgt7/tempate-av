...
$(function () {
  ...
  callback: function (data, pagination) {
      ...
      $.each(data, function (index, item) {
          dataHtml += '<div style="padding-top:10px"><a href="'+ item.link +'" onclick="myAds()"><img width="100%" height="100%" loading=lazy src="https://telegra.ph/file/' + item.link +'" alt="' + item.link + '" style="border-radius:10px;}"></img></a><div>';
          });
