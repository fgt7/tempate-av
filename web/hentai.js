$(function () {
  ...
  callback: function (data, pagination) {
      ...
      $.each(data, function (index, item) {
          dataHtml += '<div class="row sort-item"><a href="http://adf.ly/19888345/' + item.link + '" onclick="myAds()" style="color:black"><img id="poster" src="' + item.poster + '" alt="' + item.title + '" width="100%" height="200" loading=lazy style="object-fit: cover;border-radius:10px;max-inline-size:100%;block-size: auto;aspect-ratio: 3/4;object-fit: cover;"></a><p id="judul-semi" align="left"><b>' + item.title + '<b></p></div>';
          });
