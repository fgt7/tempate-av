$(function () {
  ...
  showNavigator: true,
  formatNavigator: 'Hal. ke-<span style="color: #f00"><b><%= currentPage %></span></b>, <b><%= totalPage %></b> Halaman, Total Komik <b><%= totalNumber %></b>',
  showGoInput: true,
  showGoButton: true,
  ...
  callback: function (data, pagination) {
      ...
      $.each(data, function (index, item) {
          dataHtml += '<div class="row sort-item"><a href="http://adf.ly/19888345/' + item.link + '"  onclick="myAds()" style="color:black"><img id="poster" loading=lazy src="' + item.poster + '" alt="' + item.title + '" width="100%" style="max-inline-size: 100%;block-size: auto;aspect-ratio: 3/4;object-fit: cover;border-radius:10px;max-inline-size: 100%;block-size: auto;aspect-ratio: 3/4;object-fit: cover;}"></a><span class="kategori-komik">'+ item.episode +'</span><p id="judul-komik" align="left" style="margin-top:-1px"><b>' + item.title + '</b></p></div>';
          });
